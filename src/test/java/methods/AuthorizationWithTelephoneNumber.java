...
public class AuthorizationWithTelephoneNumber {
    ...
    public void authorizationUkraine(String telephoneNumber) {
        this.telephoneNumber = telephoneNumber;
        String code;
        ...
        Assert.assertTrue(authHomePage.getCabinetButton().isDisplayed());
    }

    public void authorizationRussia(String telephoneNumber) {
        this.telephoneNumber = telephoneNumber;
        String code;
    ...
    public void authorizationEnglish(String telephoneNumber) {
        this.telephoneNumber = telephoneNumber;
        String code;
