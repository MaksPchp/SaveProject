...
public class NoAuthGet200ResponseForPress {

    public void get200ResponseForPressUkraine() {
        ChangeLanguage changeLanguage = new ChangeLanguage();
        changeLanguage.chooseUk();
        ValidatableResponse imageBanner = given().baseUri(URL_FOR_THE_PRESS_PAGE_UKRAINE)
    ...
    public void get200ResponseForPressRussia() {
        ...
        ValidatableResponse imageBanner = given().baseUri(URL_FOR_THE_PRESS_PAGE_RUSSIA)
                .cookie(DOCUMENT_COOKIE_NAME,DOCUMENT_COOKIE_VALUE)
                .when().get()
                .then()
                .assertThat().statusCode(is(200));
    ...
    public void get200ResponseForPressEnglish() {
        ...
        ValidatableResponse imageBanner = given().baseUri(URL_FOR_THE_PRESS_PAGE_ENGLISH)
                .cookie(DOCUMENT_COOKIE_NAME,DOCUMENT_COOKIE_VALUE)
                .when().get()
                .then()
                .assertThat().statusCode(is(200));
