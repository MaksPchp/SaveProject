...
public class AuthGet200ResponseBattleBloggers {
    ...
    public void get200ResponseBattleBloggersUkraine() {
        ...
        ValidatableResponse imageBanner = given().baseUri(URL_BATTLE_BLOGGERS_PAGE_UKRAINE)
    ...
    public void get200ResponseBattleBloggersRussia() {
        ...
        ValidatableResponse imageBanner = given().baseUri(URL_BATTLE_BLOGGERS_PAGE_RUSSIA)
                .cookie(DOCUMENT_COOKIE_NAME,DOCUMENT_COOKIE_VALUE)
                .headers(headersContentTypeAndHardcodeToken.headersContentTypeAndHardcodeToken())
                .when().get()
                .then()
    ...
    public void get200ResponseBattleBloggersEnglish() {
        ...
        ValidatableResponse imageBanner = given().baseUri(URL_BATTLE_BLOGGERS_PAGE_ENGLISH)
                .cookie(DOCUMENT_COOKIE_NAME,DOCUMENT_COOKIE_VALUE)
                .headers(headersContentTypeAndHardcodeToken.headersContentTypeAndHardcodeToken())
                .when().get()
                .then()
