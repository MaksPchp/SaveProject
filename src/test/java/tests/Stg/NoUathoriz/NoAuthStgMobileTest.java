...
import static constants.Constants.URL_STG_HOME_PAGE_ENGLISH;

public class NoAuthStgMobileTest extends TestNgRunnerMobile {
    ...
    public void verifyMobileAuthorizWindowFromHomePageUkrain() {
        DriverProvider.getDriverMobile().get(URL_STG_HOME_PAGE_UKRAINE);
    ...
    public void verifyMobileAuthorizWindowFromHomePageRussia() {
        DriverProvider.getDriverMobile().get(URL_STG_HOME_PAGE_RUSSIA);
        AllElementsForAuthorizationWindow allElementsForAuthorizationWindow = new AllElementsForAuthorizationWindow();
        HomePageMobile homePageMobile = new HomePageMobile();
        homePageMobile.getConnectToTheOneMinutesButtonOnBanner().click();
        allElementsForAuthorizationWindow.allElementsForAuthorizationWindow1stepStg();
    ...
    public void verifyMobileAuthorizWindowFromHomePageEnglish() {
        DriverProvider.getDriverMobile().get(URL_STG_HOME_PAGE_ENGLISH);
        AllElementsForAuthorizationWindow allElementsForAuthorizationWindow = new AllElementsForAuthorizationWindow();
        HomePageMobile homePageMobile = new HomePageMobile();
        homePageMobile.getConnectToTheOneMinutesButtonOnBanner().click();
        allElementsForAuthorizationWindow.allElementsForAuthorizationWindow1stepStg();
    ...
    public void verifyMobileAuthorizWindowFromTvUkraine() {
        DriverProvider.getDriverMobile().get(URL_STG_1PLUS1_CHANNEL_UKRAINE);
        AllElementsForAuthorizationWindow allElementsForAuthorizationWindow = new AllElementsForAuthorizationWindow();
    ...
    public void verifyMobileAuthorizWindowFromTvRussia() {
        DriverProvider.getDriverMobile().get(URL_STG_1PLUS1_CHANNEL_RUSSIA);
        AllElementsForAuthorizationWindow allElementsForAuthorizationWindow = new AllElementsForAuthorizationWindow();
        NoAuthTvPage tvPage = new NoAuthTvPage();
        new WebDriverWait(DriverProvider.getDriver(), Duration.ofSeconds(10))
                .until(ExpectedConditions.visibilityOf(tvPage.getWatchToFree()));
    ...
    public void verifyMobileAuthorizWindowFromTvEnglish() {
        DriverProvider.getDriverMobile().get(URL_STG_1PLUS1_CHANNEL_ENGLISH);
        AllElementsForAuthorizationWindow allElementsForAuthorizationWindow = new AllElementsForAuthorizationWindow();
        NoAuthTvPage tvPage = new NoAuthTvPage();
        new WebDriverWait(DriverProvider.getDriver(), Duration.ofSeconds(10))
                .until(ExpectedConditions.visibilityOf(tvPage.getWatchToFree()));
    ...
    public void verifyMobileAuthorizWindowFromMovieUkraine() {
        DriverProvider.getDriverMobile().get(URL_STG_RANDOM_MOVIE_UKRAINIAN);
        AllElementsForAuthorizationWindow allElementsForAuthorizationWindow = new AllElementsForAuthorizationWindow();
    ...
    public void verifyMobileAuthorizWindowFromMovieRussia() {
        DriverProvider.getDriverMobile().get(URL_STG_RANDOM_MOVIE_RUSSIA);
        AllElementsForAuthorizationWindow allElementsForAuthorizationWindow = new AllElementsForAuthorizationWindow();
        NoAuthMovieInfoPageMobile noAuthMovieInfoPageMobile = new NoAuthMovieInfoPageMobile();
        new WebDriverWait(DriverProvider.getDriver(), Duration.ofSeconds(10))
                .until(ExpectedConditions.visibilityOf(noAuthMovieInfoPageMobile.getPlayButton()));
    ...
    public void verifyMobileAuthorizWindowFromMovieEnglish() {
        DriverProvider.getDriverMobile().get(URL_STG_RANDOM_MOVIE_ENGLISH);
        AllElementsForAuthorizationWindow allElementsForAuthorizationWindow = new AllElementsForAuthorizationWindow();
        NoAuthMovieInfoPageMobile noAuthMovieInfoPageMobile = new NoAuthMovieInfoPageMobile();
        new WebDriverWait(DriverProvider.getDriver(), Duration.ofSeconds(10))
                .until(ExpectedConditions.visibilityOf(noAuthMovieInfoPageMobile.getPlayButton()));
    ...
    public void verifyPlayTrailerInCinemaPageMobile(){
        ...
        DriverProvider.getDriverMobile().get(URL_STG_RANDOM_MOVIE_UKRAINIAN);
        new WebDriverWait(DriverProvider.getDriverMobile(), Duration.ofSeconds(10))
    ...
    public void verifyAllElementsInMovieInfoForSeriesUkraineMobile() {
        ...
        DriverProvider.getDriverMobile().get(URL_STG_RANDOM_SERIES_UKRAINIAN);
        goToDownPage.goToDownPage();
    ...
    public void verifyAllElementsInMovieInfoForSeriesRussiaMobile() {
        ...
        DriverProvider.getDriverMobile().get(URL_STG_RANDOM_SERIES_RUSSIA);
        goToDownPage.goToDownPage();
        allElementsForMovieInfoPage.AllElementsForMovieInfoPageForSeriesMobile();
    }
    ...
    public void verifyAllElementsInMovieInfoForSeriesEnglishMobile() {
        ...
        DriverProvider.getDriverMobile().get(URL_STG_RANDOM_SERIES_ENGLISH);
        goToDownPage.goToDownPage();
        allElementsForMovieInfoPage.AllElementsForMovieInfoPageForSeriesMobile();
    }
    ...
    @Description("Проверка всех элементов в окне авторизации открытой через кнопку Подключить бесплатно в меню украинский язык")
    @Test(timeOut = 30000, retryAnalyzer = Retry.class)
    ...
    @Description("Проверка всех элементов в окне авторизации открытой через кнопку Подключить бесплатно в меню русский язык")
    @Test(timeOut = 30000, retryAnalyzer = Retry.class)
    ...
    @Description("Проверка всех элементов в окне авторизации открытой через кнопку Подключить бесплатно в меню английский язык")
    @Test(timeOut = 30000, retryAnalyzer = Retry.class)
    ...
    public void verifyClickTvPristavkaButtonInTheMenuUkraine() {
        ...
        new WebDriverWait(DriverProvider.getDriver(), Duration.ofSeconds(10))
                .until(ExpectedConditions.urlToBe(URL_STG_TV_PRISTAVKA_PAGE_UKRAINE));
        Assert.assertTrue(DriverProvider.getDriver().getCurrentUrl().equals(URL_STG_TV_PRISTAVKA_PAGE_UKRAINE));
    }
    ...
    public void verifyClickTvPristavkaButtonInTheMenuRussia() {
        ...
        homePageMobile.getTvPristavkaButtonInMenuInMenu().click();
        new WebDriverWait(DriverProvider.getDriver(), Duration.ofSeconds(10))
                .until(ExpectedConditions.urlToBe(URL_STG_TV_PRISTAVKA_PAGE_RUSSIA));
        Assert.assertTrue(DriverProvider.getDriver().getCurrentUrl().equals(URL_STG_TV_PRISTAVKA_PAGE_RUSSIA));
    }
    ...
    public void verifyClickTvPristavkaButtonInTheMenuEnglish() {
        ...
        homePageMobile.getTvPristavkaButtonInMenuInMenu().click();
        new WebDriverWait(DriverProvider.getDriver(), Duration.ofSeconds(10))
                .until(ExpectedConditions.urlToBe(URL_STG_TV_PRISTAVKA_PAGE_ENGLISH));
        Assert.assertTrue(DriverProvider.getDriver().getCurrentUrl().equals(URL_STG_TV_PRISTAVKA_PAGE_ENGLISH));
    }
